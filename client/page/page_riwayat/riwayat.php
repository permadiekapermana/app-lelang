		...
		<div class="col-xl-9 col-lg-8 col-md-7">
			...
			<section class="lattest-product-area pb-40 category-list">
				<div class="row">
					...
					<?php 
						$date = date('Y-m-d');
						$query = "SELECT DISTINCT barang.id_barang, barang.nama_barang, barang.harga_buka, barang.tgl_tutup, barang.foto, kategori.kategori FROM barang INNER JOIN kategori ON kategori.id_kategori=barang.id_kategori INNER JOIN lelang ON barang.id_barang=lelang.id_barang INNER JOIN users ON users.id_user=lelang.id_user WHERE barang.status='close' order by tgl_buka DESC";
						$execute = mysqli_query($koneksi,$query);

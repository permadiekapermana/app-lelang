...
if($act == 'add') {
    ...
    if(!$result){
        ...
        echo "<script>alert('Data berhasil ditambah.');window.location='../../page.php?module=admin&&method=';</script>";
    }
...
elseif($act == 'update') {
    ...
    if(!$result){
        ...
        //tampil alert dan akan redirect ke halaman index.php
        //silahkan ganti index.php sesuai halaman yang akan dituju
        echo "<script>alert('Data berhasil diubah.');window.location='../../page.php?module=admin&&method=';</script>";
    }
...
elseif($act == 'delete') {
    ...
    if($execute){
        echo "<script>alert('Data berhasil dihapus.');window.location='../../page.php?module=admin&&method=';</script>";
    }

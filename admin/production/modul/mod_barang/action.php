    ...
    $nama_gambar_baru = $angka_acak.'-'.$gambar_produk; //menggabungkan angka acak dengan nama file sebenarnya
            if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                    ...
                    if(!$result){
                        ...
                        echo "<script>alert('Data berhasil ditambah.');window.location='../../page.php?module=barang&&method=';</script>";
                    }

                } else {     
                //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                    echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='../../page.php?module=barang&&method=';</script>";
                }
    } 
...
elseif($act == 'update') {
    ...
    if(!$result){
        ...
        //tampil alert dan akan redirect ke halaman index.php
        //silahkan ganti index.php sesuai halaman yang akan dituju
        echo "<script>alert('Data berhasil diubah.');window.location='../../page.php?module=barang&&method=';</script>";
    }
...
elseif($act == 'delete') {
    ...
    if($execute){
        echo "<script>alert('Data berhasil dihapus.');window.location='../../page.php?module=barang&&method=';</script>";
    }

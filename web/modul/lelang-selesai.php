<div class="site-section">
    ...
    <div class="row">
        ...
        <div class="card-body">          
            <h5 class="card-title">Lelang Selesai</h5>
            <table class='table'>
                <thead>
                    <th>No.</th>
                    <th>Nama Barang</th>
                ...
                <tbody>
                <?php
                    $qry = "SELECT * FROM kirim_barang INNER JOIN lelang ON kirim_barang.id_lelang=lelang.id_lelang INNER JOIN barang ON lelang.id_barang=barang.id_barang INNER JOIN kategori ON kategori.id_kategori=barang.id_kategori WHERE lelang.status='terpilih' AND lelang.id_user='$_SESSION[id_user]' AND status_kirim='Selesai'";
                        ...
                        <td>
                            <div class="btn-group">
                                <form action="modul/invoice/cetak_invoice.php" enctype='multipart/form-data' method="POST" target="_blank">
                                    <input type="text" name="id" value="<?=$list['id_barang']?>">
